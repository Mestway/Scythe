...
import lang.sql.dataval.CombinedVal;
import lang.sql.dataval.LazyAggrVal;
...
public class Table {
    ...
    public static Table joinTwo(Table t1, Table t2) {
        ...
        for (TableRow tr1 : t1.getContent()) {
            for (TableRow tr2 : t2.getContent()) {
                ...
                TableRow newTr = TableRow.TableRowFromContent(resultTableMetadata, body);
    ...
    // These two function are specially used for handling lazyAggr value and
